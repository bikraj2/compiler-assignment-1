...
%type <sVal> FUNC_ACC_PARAM_LIST REF_TYPE FACTOR PRINTABLE
...
STATEMENT   : LOOP_STATEMENT  SEMI  
            | PUSH_POP_STATEMENT  SEMI {addToFile("PUSH_POP_STATEMENT", 2);}
            | CONDITIONAL_STATEMENT 
            | PRINT_STATEMENT {addToFile("PRINT_STATEMENT", 2);}
            | DEC_STATEMENT  {addToFile("DEC_STATEMENT", 2);}
            | EXPRESSION_STMT  {addToFile("EXPRESSION_STMT", 2);}
            | ASSIGN_STATEMENT  SEMI {addToFile("ASSIGN_STATEMENT", 2);}
            ;
...
LOOP_STATEMENT : LOOP LEFT_PAREN LOOP_CONDITION RIGHT_PAREN COLON LEFT_ANGLE COMPOUND_STATEMENT RIGHT_ANGLE  {}
               ...
               ;
LOOP_CONDITION : DEC_STATEMENT BOOLEAN_EXP SEMI ASSIGN_STATEMENT {addToFile("LOOP_STATEMENT", 2);};
...
FUNC_STATEMENT: FUNC VAR  FUNCTION_DEC_LIST LEFT_ANGLE FUNCTION_BODY RIGHT_ANGLE  
              ;
FUNCTION_DEC_LIST :LEFT_PAREN PARAMETER_LIST SEMI  TYPE RIGHT_PAREN{addToFile("FUNC_STATEMENT",2);}
...
RETURN_STATEMENT : RETURN EXPRESSION SEMI {addToFile("RETURN_STATEMENT",2);}; 
